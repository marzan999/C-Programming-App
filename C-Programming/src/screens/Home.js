...
export const C_TOPIC_LIST = [
...

    {
        ...
        imageFunction2: require("../../assets/func2.png"),
        imageFunction3: require("../../assets/func3.png"),
        ...
        descriptionFunction16: 'Example: User-defined function',
        descriptionFunction17: 'Here is an example to add two integers. To perform this task, we have created an user-defined addNumbers().\n',
        descriptionFunction18: '#include <stdio.h>\nint addNumbers(int a, int b);         // function prototype\n\nint main()\n{\n    int n1,n2,sum;\n\n    printf("Enters two numbers: ");\n   scanf("%d %d",&n1,&n2);\n\n    sum = addNumbers(n1, n2);        // function call\n    printf("sum = %d",sum);\n\n    return 0;\n}\n\nint addNumbers(int a, int b)         // function definition   \n{\n   int result;\n    result = a+b;\n    return result;                  // return statement\n}',
        descriptionFunction19: 'Function prototype',
        descriptionFunction20: "A function prototype is simply the declaration of a function that specifies function's name, parameters and return type. It doesn't contain function body.\n\nA function prototype gives information to the compiler that the function may later be used in the program.",
        descriptionFunction21: 'Syntax of function prototype\n',
        descriptionFunction22: 'returnType functionName(type1 argument1, type2 argument2, ...);',
        descriptionFunction23: 'In the above example, int addNumbers(int a, int b); is the function prototype which provides the following information to the compiler:\n\n1. name of the function is addNumbers()\n2. return type of the function is int\n3. two arguments of type int are passed to the function\n\nThe function prototype is not needed if the user-defined function is defined before the main() function.',
        descriptionFunction24: 'Calling a function',
        descriptionFunction25: 'Control of the program is transferred to the user-defined function by calling it.',
        descriptionFunction26: 'Syntax of function call\n',
        descriptionFunction27: 'functionName(argument1, argument2, ...);',
        descriptionFunction28: 'In the above example, the function call is made using addNumbers(n1, n2); statement inside the main() function.',
        descriptionFunction29: 'Passing arguments to a function',
        descriptionFunction30: 'In programming, argument refers to the variable passed to the function. In the above example, two variables n1 and n2 are passed during the function call.\n\nThe parameters a and b accepts the passed arguments in the function definition. These arguments are called formal parameters of the function.',
        descriptionFunction31: 'How to pass arguments to a function? \n',
        descriptionFunction32: 'The type of arguments passed to a function and the formal parameters must match, otherwise, the compiler will throw an error.\n\nIf n1 is of char type, a also should be of char type. If n2 is of float type, variable b also should be of float type.\n\nA function can also be called without passing an argument.',
        descriptionFunction33: 'Return Statement',
        descriptionFunction34: 'The return statement terminates the execution of a function and returns a value to the calling function. The program control is transferred to the calling function after the return statement.\n\nIn the above example, the value of the result variable is returned to the main function. The sum variable in the main() function is assigned this value.\n',
        descriptionFunction35: 'Syntax of return statement\n',
        descriptionFunction36: 'return (expression);  ',
        descriptionFunction37: 'For example,\n',
        descriptionFunction38: 'return a;\nreturn (a+b);',
        descriptionFunction39: 'The type of value returned from the function and the return type specified in the function prototype and function definition must match.',
...

    {
        name: 'Structures',
        color: '#838391',
        descriptionStructure1: 'C struct',
        descriptionStructure2: 'In C programming, a struct (or structure) is a collection of variables (can be of different types) under a single name.',
        descriptionStructure3: 'Define Structures',
        descriptionStructure4: 'Before you can create structure variables, you need to define its data type. To define a struct, the struct keyword is used.',
        descriptionStructure5: 'Syntax of struct\n',
        descriptionStructure6: 'struct structureName {\n    dataType member1;\n    dataType member2;\n    ...\n };',
        descriptionStructure7: 'For example,\n',
        descriptionStructure8: 'struct Person {\n    char name[50];\n    int citNo;\n    float salary;\n };',
        descriptionStructure9: 'Here, a derived type struct Person is defined. Now, you can create variables of this type.',
        descriptionStructure10: 'Create struct Variables',
        descriptionStructure11: 'When a struct type is declared, no storage or memory is allocated. To allocate memory of a given structure type and work with it, we need to create variables.\n\nHere is how we create structure variables:\n',
        descriptionStructure12: 'struct Person {\n    // code\n  };\n\n  int main() {\n    struct Person person1, person2, p[20];\n    return 0;\n  }',
        descriptionStructure13: 'Another way of creating a struct variable is:\n',
        descriptionStructure14: 'struct Person {\n    // code\n} person1, person2, p[20];',
        descriptionStructure15: 'In both cases,\n\n - person1 and person2 are struct Person variables\n - p[] is a struct Person array of size 20.',
        descriptionStructure16: 'Access Members of a Structure',
        descriptionStructure17: 'There are two types of operators used for accessing members of a structure.\n\n1.  . - Member operator\n2.  -> - Structure pointer operator (will be discussed in the next tutorial)\n\nSuppose, you want to access the salary of person2. Here is how you can do it.\n',
        descriptionStructure18: 'person2.salary',
        descriptionStructure19: 'Example: C structs\n',
        descriptionStructure20: '#include <stdio.h>\n#include <string.h>\n\n// create struct with person1 variable\nstruct Person {\n  char name[50];\n  int citNo;\n  float salary;\n} person1;\n\nint main() {\n\n  // assign value to name of person1\n  strcpy(person1.name, "George Orwell");\n\n  // assign values to other person1 variables\n  person1.citNo = 1984;\n  person1. salary = 2500;\n\n  // print struct variables\n  printf("Name: %s\n", person1.name);\n  printf("Citizenship No.: %d\n", person1.citNo);\n  printf("Salary: %.2f", person1.salary);\n\n  return 0;\n}',
        descriptionStructure21: 'Output\n',
        descriptionStructure22: 'Name: George Orwell\nCitizenship No.: 1984\nSalary: 2500.00',
        descriptionStructure23: 'In this program, we have created a struct named Person. We have also created a variable of Person named person1.\n\nIn main(), we have assigned values to the variables defined in Person for the person1 object.\n',
        descriptionStructure24: 'strcpy(person1.name, "George Orwell");\nperson1.citNo = 1984;\nperson1. salary = 2500;',
        descriptionStructure24a: 'Notice that we have used strcpy() function to assign the value to person1.name.\n\nThis is because name is a char array (C-string) and we cannot use the assignment operator = with it after we have declared the string.\n\nFinally, we printed the data of person1.',
        descriptionStructure25: 'Keyword typedef',
        descriptionStructure26: 'We use the typedef keyword to create an alias name for data types. It is commonly used with structures to simplify the syntax of declaring variables.\n\nFor example, let us look at the following code:\n',
        descriptionStructure27: 'struct Distance{\n    int feet;\n    float inch;\n  };\n\n int main() {\n    struct Distance d1, d2;\n  }',
        descriptionStructure27a: 'We can use typedef to write an equivalent code with a simplified syntax:\n',
        descriptionStructure27b: 'typedef struct Distance {\n    int feet;\n    float inch;\n  } distances;\n\n  int main() {\n    distances d1, d2;\n  }',
        descriptionStructure28: 'Example: C typedef\n',
        descriptionStructure29: '#include <stdio.h>\n#include <string.h>\n\n// struct with typedef person\ntypedef struct Person {\n  char name[50];\n  int citNo;\n  float salary;\n} person;\n\nint main() {\n\n  // create  Person variable\n  person p1;\n // assign value to name of p1\n  strcpy(p1.name, "George Orwell");\n\n  // assign values to other p1 variables\n  p1.citNo = 1984;\n  p1. salary = 2500;\n\n  // print struct variables\n  printf("Name: %s\n", p1.name);\n  printf("Citizenship No.: %d\n", p1.citNo);\n  printf("Salary: %.2f", p1.salary);\n\n  return 0;\n}',
        descriptionStructure30: 'Output\n',
        descriptionStructure31: 'Name: George Orwell\nCitizenship No.: 1984\nSalary: 2500.00',
        descriptionStructure32: 'Here, we have used typedef with the Person structure to create an alias person\n',
        descriptionStructure33: '// struct with typedef person\ntypedef struct Person {\n  // code\n} person;',
        descriptionStructure34: 'Now, we can simply declare a Person variable using the person alias:\n',
        descriptionStructure35: '// equivalent to struct Person p1\nperson p1;',
        descriptionStructure36: '\n\nNested Structures',
        descriptionStructure37: 'You can create structures within a structure in C programming. For example,\n',
        descriptionStructure38: 'struct complex {\n    int imag;\n    float real;\n  };\n\n  struct number {\n    struct complex comp;\n    int integers;\n  } num1, num2;',
        descriptionStructure39: 'Suppose, you want to set imag of num2 variable to 11. Here is how you can do it:\n',
        descriptionStructure40: 'num2.comp.imag = 11;',
        descriptionStructure41: 'Example: C Nested Structures\n',
        descriptionStructure42: '#include <stdio.h>\n\nstruct complex {\n  int imag;\n  float real;\n};\n\nstruct number {\n  struct complex comp;\n  int integer;\n} num1;\n\nint main() {\n\n  // initialize complex variables\n  num1.comp.imag = 11;\n  num1.comp.real = 5.25;\n\n  // initialize number variable\n  num1.integer = 6;\n\n  // print struct variables\n  printf("Imaginary Part: %d\n", num1.comp.imag);\n  printf("Real Part: %.2f\n", num1.comp.real);\n  printf("Integer: %d", num1.integer);\n\n  return 0;\n}',
        descriptionStructure43: 'Output\n',
        descriptionStructure44: 'Imaginary Part: 11\nReal Part: 5.25\nInteger: 6',
        descriptionStructure45: '\n\nWhy structs in C?',
        descriptionStructure46: 'Suppose, you want to store information about a person: his/her name, citizenship number, and salary. You can create different variables name, citNo and salary to store this information.\n\nWhat if you need to store information of more than one person? Now, you need to create different variables for each information per person: name1, citNo1, salary1, name2, citNo2, salary2, etc.\n\nA better approach would be to have a collection of all related information under a single name Person structure and use it for every person.',
