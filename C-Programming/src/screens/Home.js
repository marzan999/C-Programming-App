...
export const C_TOPIC_LIST = [
...

    {
        ...
        descriptionIO1: 'C Output: ',
        descriptionIOO2: 'In C programming, printf() is one of the main output function. The function sends formatted output to the screen.',
...

    {
        ...
        descriptionNested4: 'For example, this code\n',
        descriptionNested5: 'if (a > b) {\n    printf("Hello");\n}\nprintf("Hi");',
        descriptionNested6: 'is equivalent to\n',
        descriptionNested7: 'if (a > b)\n      printf("Hello");\nprintf("Hi");',
...

    {
        ...
        descriptionStructure42: '#include <stdio.h>\n\nstruct complex {\n  int imag;\n  float real;\n};\n\nstruct number {\n  struct complex comp;\n  int integer;\n} num1;\n\nint main() {\n\n  // initialize complex variables\n  num1.comp.imag = 11;\n  num1.comp.real = 5.25;\n\n  // initialize number variable\n  num1.integer = 6;\n\n  // print struct variables\n  printf("Imaginary Part: %d", num1.comp.imag);\n  printf("Real Part: %.2f", num1.comp.real);\n  printf("Integer: %d", num1.integer);\n\n  return 0;\n}',
...

    {
        name: 'Union',
        color: '#419EBB',
        descriptionUnion1: 'A union is a user-defined type similar to structs in C except for one key difference.\n\nStructures allocate enough space to store all their members, whereas unions can only hold one member value at a time.',
        descriptionUnion2: 'How to define a union?',
        descriptionUnion3: 'We use the union keyword to define unions. Here is an example:\n',
        descriptionUnion4: 'union car\n{\n  char name[50];\n  int price;\n};',
        descriptionUnion5: 'The above code defines a derived type union car.',
        descriptionUnion6: 'Create union variables',
        descriptionUnion7: 'When a union is defined, it creates a user-defined type. However, no memory is allocated. To allocate memory for a given union type and work with it, we need to create variables.\n\nHere is how we create union variables.\n',
        descriptionUnion8: 'union car\n{\n  char name[50];\n  int price;\n};\n\nint main()\n{\n  union car car1, car2, *car3;\n  return 0;\n}',
        descriptionUnion9: 'Another way of creating union variables is:\n',
        descriptionUnion10: 'union car\n{\n  char name[50];\n  int price;\n} car1, car2, *car3;',
        descriptionUnion11: 'In both cases, union variables car1, car2, and a union pointer car3 of union car type are created.',
        descriptionUnion12: 'Access members of a union',
        descriptionUnion13: 'We use the . operator to access members of a union. And to access pointer variables, we use the -> operator.\n\nIn the above example,\n\n - To access price for car1, car1.price is used.\n - To access price using car3, either (*car3).price or car3->price can be used.',
        descriptionUnion14: 'Difference between unions and structures',
        descriptionUnion15: "Let's take an example to demonstrate the difference between unions and structures:\n",
        descriptionUnion16: '#include <stdio.h>\nunion unionJob\n{\n   //defining a union\n   char name[32];\n\n   float salary;\n\n   int workerNo;\n} uJob;\n\nstruct structJob\n{\n   char name[32];\n   float salary;\n   int workerNo;\n} sJob;\n\nint main()\n{\n   printf("size of union = %d bytes", sizeof(uJob));\n   printf("size of structure = %d bytes", sizeof(sJob));\n   return 0;\n}',
        descriptionUnion17: 'Output\n',
        descriptionUnion18: 'size of union = 32\nsize of structure = 40',
        descriptionUnion19: 'Why this difference in the size of union and structure variables?',
        descriptionUnion20: "Here, the size of sJob is 40 bytes because\n\n - the size of name[32] is 32 bytes\n - the size of salary is 4 bytes\n - the size of workerNo is 4 bytes\n\nHowever, the size of uJob is 32 bytes. It's because the size of a union variable will always be the size of its largest element. In the above example, the size of its largest element, (name[32]), is 32 bytes.\n\nWith a union, all members share the same memory.",
        descriptionUnion21: 'Example: Accessing Union Members\n',
        descriptionUnion22: '#include <stdio.h>\nunion Job {\n   float salary;\n   int workerNo;\n} j;\n\nint main() {\n   j.salary = 12.3;\n\n   // when j.workerNo is assigned a value,\n   // j.salary will no longer hold 12.3\n   j.workerNo = 100;\n   printf("Salary = %.1f", j.salary);\n   printf("Number of workers = %d", j.workerNo);\n   return 0;\n}',
        descriptionUnion23: 'Output\n',
        descriptionUnion24: 'Salary = 0.0\nNumber of workers = 100',
